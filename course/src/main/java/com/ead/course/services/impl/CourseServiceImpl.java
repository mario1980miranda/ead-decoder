...
public class CourseServiceImpl implements CourseService {
    ...
    public void saveSubscriptionUserInCourseAndSendNotification(CourseModel course, UserModel user) {
        ...
        try {
            ...
            notificationCommandDto.setTitle("Bienvenue au cours " + course.getName());
            notificationCommandDto.setMessage(user.getFullName() + " votre inscription a été réalisée avec succès!");
